...
int main(int argc, char** argv)
{
	...
	// 照らされるキューブ用のシェーダー
	Shader cubeshader("DiffuseMap.vert", "DirectionalLight.frag");
	...
	while (renderLoop)
	{
		...
		cubeshader.setVec3("light.direction", 0.5f, 0.5f, 0.5f);
		cubeshader.setVec3("light.ambient", 0.5f, 0.5f, 0.5f);
		cubeshader.setVec3("light.diffuse", 0.2f, 0.2f, 0.2f);
